const authConfig = {
  "siteName": "Bibliotecas - @caefisica",
  "siteIcon": "https://cdn.jsdelivr.net/gh/caefis/assets@1ea1105efd1e884c5d5dc9d3d561810cc0d5eb35/favicon-32x32.png",
  "version": "1.15",
  ...
  "roots": [
    {
      id: "152My-loiJkz5eLNhHb8uZ164K62-8iQ-",
      name: "BiblioteCAE",
      user: '',
      pass: '',
    ...
    {
        id: "1udNDbnUZRk6Kih_Fl6hv4RsZNs0PHGUM",
        name: "VideoteCAE",
        user: '',
        pass: '',
        protect_file_link: false
    ...
    {
      id: "1aIGzYXPgteRCkXqnjKDrqPNLkJYPpOqf",
      name: "Base 19",
      user: '',
      pass: '',
      protect_file_link: false
    ...
    {
      id: "168YWJgUZm0UUK52HC1UUSw995T3EmiUR",
      name: "Base 20",
      user: '',
      pass: '',
      protect_file_link: false
        ...
        {
      id: "1v7JSJpb6zCv5w8O3ssnlFUGyt3PYIX9f",
      name: "Base 21",
      user: '',
      pass: '',
      protect_file_link: false
    ...
    {
      id: "1s1Cc549S99pOCK4aEdagu1vGMFX-n3hd",
    ...
    {
      id: "1fIJu2cdOmxvY8pa0oFc3y2ceQNTGYfkW",
      name: "Biblioteca de la FCF",
      user: '',
      pass: '',
      protect_file_link: false
    },
    {
      id: "1pv4R-NdmqorXa9zu0SDV7VORYNEHaruT",
      name: "Unificado",
      user: '',
      pass: '',
      protect_file_link: false
    ...
    {
      id: "1Fp-4M9zxj7Rq32f7LpBIuQbPR_7BhDkA",
      name: "Ingeniería Mecánica, PUCP",
      user: '',
      pass: '',
      protect_file_link: false
    },
    {
      id: "1szYb4ALyvJGpSE4yaynMo7uWxha2Ebi1",
      name: "Biblioteca (sistema Dewey)",
      user: '',
      pass: '',
      protect_file_link: false
    } /* ,
...
const uiConfig = {
  ...
  "hide_head_md": true, // Set this to true if you need to disable rendering HEAD.md
  "hide_readme_md": false, // Set this to true if you need to disable rendering README.md
  "helpURL": "https://caefisica.com/", // Provide the URL of the help page(instructions for using the index). Leave this empty if you want to hide the help icon. Providing a URL will open the help page in a new tab. (You can use telegra.ph to write instructions)
  "footer_text": "", // // Provide the footer text. Leave this empty if you want to hide it
  "main_color": "grey", // blue-grey | red | pink | purple | deep-purple | indigo | blue | light-blue | cyan | teal | green | light-green | lime | yellow | amber | orange | deep-orange | brown | grey
  "accent_color": "grey" // red | pink | purple | deep-purple | indigo | blue | light-blue | cyan | teal | green | light-green | lime | yellow | amber | orange | deep-orange
...
<head>
  ...
  <script src="https://rawcdn.githack.com/caefis/assets/511126c4441859a785c582d29ab9bc12bff54c42/app_beta.js"></script>
</head>
<body>
</body>
</html>
...
class googleDrive {
  ...
  async down(id, range = '', inline = false) {
    ...
    // Create a new response to manipulate the headers
